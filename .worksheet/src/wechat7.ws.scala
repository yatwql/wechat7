...
object ws {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(74); 
  ...
  md.digest(tmpStr.getBytes("UTF-8")).map("%02x".format(_)).mkString;System.out.println("""res0: String = """ + $show(res$0));$skip(31); 
  
val name :String = "news33";System.out.println("""name  : String = """ + $show(name ));$skip(30); 

val Pattern = "news(\\d+)".r;System.out.println("""Pattern  : scala.util.matching.Regex = """ + $show(Pattern ));$skip(143); 
